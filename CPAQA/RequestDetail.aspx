                    ...
                    <div class="card-body">
                        <div id="pnAsmAll" runat="server" class="pb-2">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td style="padding-left: 30px;">3.1. สิ่งที่ทำ/โครงการที่ร่วมงาน</td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    <td style="padding-left: 30px;">3.2. การจัดการความเสี่ยง</td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    <td style="padding-left: 30px;">3.3. งานคุณภาพเพิ่มเติม</td>
                                    <td class="text-center">
