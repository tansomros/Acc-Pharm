<%@ Page Title="Privacy Policy" Language="VB" AutoEventWireup="true" CodeBehind="PrivacyPolicy.aspx.vb" Inherits="CPAQA.PrivacyPolicy" %>
...
<div class="scroll-area-lg">
					...
					<div class="txt-prg">
						1. ภายใต้พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 สำนักรับรองร้านยาคุณภาพ ( สรร.)ถือเป็นผู้ควบคุมข้อมูลส่วนบุคคลที่มีหน้าที่ตามกฎหมายในการคุ้มครองข้อมูลส่วนบุคคลที่อยู่ในการครอบครองหรือควบคุมของบริษัท ท่านสามารถดูนโยบายการคุ้มครองข้อมูลส่วนบุคคลของมูลนิธิเภสัชกรรมชุมชน ได้ที่<a href="https://papc.pharmacycouncil.org" target="_blank">https://papc.pharmacycouncil.org</a>  <br />
                        ...
                        3. การเก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลของท่านจะเป็นไปเพื่อวัตถุประสงค์ในการขอรับรองร้านยาคุณภาพเท่านั้น <br />
4. ข้อมูลส่วนบุคคลดังกล่าวจะถูกประมวลผลโดยบุคคลที่มีอำนาจที่เกี่ยวข้องกับวัตถุประสงค์ที่กล่าวไว้เท่านั้น<br />
5. การไม่ยินยอมให้ข้อมูลส่วนบุคคลดังกล่าวจะทำให้สำนักรับรองร้านยาคุณภาพ ไม่สามารถดำเนินการตามวัตถุประสงค์ดังกล่าวกับท่านและทำให้ท่านไม่สามารถได้รับประโยชน์จากการดำเนินการดังกล่าว<br />
6. ท่านมีสิทธิที่จะถอนการยินยอมในการให้เก็บรวบรวม ใช้ หรือเปิดเผยข้อมูลส่วนบุคคล โดยท่านสามารถติดต่อเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคลที่ <a href="papc.pharmacycouncil.org" target="_blank"> papc.pharmacycouncil.org</a><br />
7. สรร. รับรองว่ามีการดำเนินการรักษาความปลอดภัยที่มีมาตรฐาน และจัดให้มีมาตรการด้านเทคนิคและการจัดการเพื่อป้องกันการเข้าถึงข้อมูลส่วนบุคคลของท่านโดยมิชอบ<br />
    ...
    <asp:CheckBox ID="chkAllow" runat="server" Text="&nbsp;&nbsp;โดยข้าพเจ้าได้อ่านประกาศฉบับนี้และ <b>ให้ความยินยอม</b> ในการให้ข้อมูลส่วนบุคคลกับ สรร. เพื่อการดำเนินการตามวัตถุประสงค์ข้างต้น" />
        <br />
    </div>
    <br />
