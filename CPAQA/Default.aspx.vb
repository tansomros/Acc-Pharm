...
Public Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Request("logout") = "y" Then
            ...
            delCookie1 = New HttpCookie("CPAQA")
    ...
    Private Sub CheckUser()
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt.Rows(0).Item("LocationStatus") <> "A" Then
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "MessageAlert", "openModalWarningAlert(this,'ผลการตรวจสอบ','ID ของท่านไม่สามารถใช้งานได้ กรุณาติดต่อผู้ดูแลระบบ');", True)
                Exit Sub
            End If
            ...
            Dim ckAdminComp As New HttpCookie("AdminComp")
            ...
            ckAdminComp.Value = String.Concat(dt.Rows(0)("AdminComp"))
            ...
            Dim iCPACookie As HttpCookie = New HttpCookie("CPAQA")
            iCPACookie("UserID") = dt.Rows(0).Item("UserID")
            ...
            Response.Cookies.Add(ckAdminComp)
            ...
            acc.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_LOG, "Login", "UserID=" & Request.Cookies("UserID").Value, "", Server.MachineName, GetIPAddress())
    ...
    Protected Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        ...
        '    Case "admin", "itee", "คพ.1/2565", "คพ.2/2565"
        CheckUser()
        '    Case Else
        '        Response.Redirect("notice.aspx")
        'End Select
