                    ...
                    <div class="menu-box">
                        <div class="box-body">
                            <a href="DrugStoreMenu.aspx" class="btn btn-menu-main btn-menu btn-block-menu">
                                <span class="box-icon-menu"><i class="material-icons icon-menu add_business">&#xe729;</i></span>รายชื่อร้านยา<br />
                                Pharmacy Store
                            </a>
                            ...
                            <a href="Regulations.aspx?p=r" class="btn btn-menu-main btn-menu btn-block-menu">
                                <span class="box-icon-menu"><i class="material-icons icon-menu verified_user">&#xe8e8;</i></span>ระเบียบ/ ประกาศ / ข้อบังคับ<br />
                                Regulations
                            </a>
                                        ...
                                        <div class="col-lg-8 d-none d-lg-block">
                                             ...
                                             <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="item">
                                                        <img src="slide/slide15.jpg?v=1" width="100%" alt="" />
                                                        <div class="carousel-caption">
                                                        </div>
                                                    </div>
                                                    <div class="item">
                                                        <a href="https://www.acc-pharm.com/slide/slide10A.jpg" target="_blank">
                                                            <img src="slide/slide10.jpg?v=1" width="100%" alt="" /></a>
                                                        <div class="carousel-caption">
                                                        </div>
                                                    </div>
                                                    <div class="item">
                                                    ...
                                                    <div class="item">
                                                        <a href="slide/slide3-1.png" target="_blank">
                                                            <img src="slide/slide3.jpg?v=1" alt="" />
                                                            <div class="carousel-caption btn btn-blue">
                                                                คลิกเพื่อดูรูปใหญ่
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="slide/slide4-1.jpg" target="_blank">
                                                            <img src="slide/slide4.jpg?v=1" alt="" />
                                                            <div class="carousel-caption btn btn-blue">
                                                                คลิกเพื่อดูรูปใหญ่
                                                            </div>
                                                        </a>
