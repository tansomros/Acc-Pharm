<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AllocatePost.aspx.vb" Inherits="CPAQA.AllocatePost" %>
     ...
     <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Assign ร้านยาให้ผู้ตรวจประเมินรักษาคุณภาพ (POST)
...
<section class="col-lg-6 connectedSortable">
    ...
    <tr>
          <td valign="top" > 
  <table border="0" class="table table-no-bordered">
            <tr>             
                 ...
                 <td width="60">เงื่อนไข</td> 
                <td>
                     <asp:DropDownList ID="ddlCond" runat="server" AutoPostBack="True" CssClass="form-control select2">
     ...
     <asp:ListItem Value="O">เฉพาะร้านที่ยังไม่ Assign</asp:ListItem>
      ...
      <tr>
            ...
            <td colspan="3">
                <table class="table">
                    <tr>
                        <td> <asp:TextBox ID="txtSearchLocation" runat="server"  CssClass="form-control"></asp:TextBox></td>
                        <td> <asp:Button ID="cmdFindLocation" runat="server" CssClass="btn btn-warning" Width="60" Text="ค้นหา"></asp:Button></td>
                    </tr>
                </table>
               </td>
      </tr>
