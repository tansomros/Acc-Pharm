<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocationHour.aspx.vb" Inherits="CPAQA.LocationHour" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="bower_components/inputmask/assets/jquery.inputmask.bundle.js"></script>
    <script>
        $(function () {
            $(":input").inputmask();
