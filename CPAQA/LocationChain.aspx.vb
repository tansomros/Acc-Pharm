...
Public Class LocationChain
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ClearData()
            LoadLocationChainToGrid()
        End If

        cmdDelete.Attributes.Add("onClick", "javascript:return confirm(""ต้องการลบรายการนี้ใช่หรือไม่?"");")
    End Sub
    Private Sub LoadLocationChainToGrid()
        If Trim(txtSearch.Text) <> "" Then
            dt = ctlL.LocationChain_GetBySearch(txtSearch.Text)
        Else
    ...
    Private Sub grdData_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdData.RowCommand
        If TypeOf e.CommandSource Is WebControls.LinkButton Then
            ...
            Select Case ButtonPressed.ID
                ...
                Case "imgDel"
                    If ctlL.LocationChain_Delete(e.CommandArgument) Then
                        acc.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_DEL, "LocationChain", "ลบชื่อกลุ่มร้านยา :" & txtName.Text, "", Environment.MachineName, GetIPAddress())
    ...
    Private Sub EditData(ByVal pID As String)
        dt = ctlL.LocationChain_GetByUID(pID)
    ...
    Protected Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If StrNull2Zero(txtUID.Text) = 0 Then
            If ctlL.LocationChain_CheckDuplicate(txtName.Text) Then
                ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "MessageAlert", "openModalWarningInfo(this,'ผลการตรวจสอบ','ชื่อกลุ่ม Chain นี้มีอยู่่ในระบบแล้ว');", True)
                Exit Sub
            End If
        End If

        ctlL.LocationChain_Save(StrNull2Zero(txtUID.Text), txtCode.Text, txtName.Text, txtDescriptions.Text, ConvertBoolean2StatusFlag(chkStatus.Checked))
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        ctlL.LocationChain_Delete(StrNull2Zero(txtUID.Text))
        LoadLocationChainToGrid()
    End Sub
End Class
