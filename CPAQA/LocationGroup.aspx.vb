            ...
            Select Case ButtonPressed.ID
                ...
                Case "imgDel"
                    If ctlL.LocationGroup_Delete(e.CommandArgument) Then
                        acc.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_DEL, "LocationGroup", "ลบชื่อกลุ่มร้านยา :" & txtName.Text, "", Environment.MachineName, GetIPAddress())
    ...
    Protected Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If StrNull2Zero(txtUID.Text) = 0 Then
            If ctlL.LocationGroup_CheckDuplicate(txtName.Text) Then
                ...
                Exit Sub
            End If
            acc.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_ADD, "LocationGroup", "เพิ่มชื่อกลุ่มร้านยา :" & txtName.Text, "", Environment.MachineName, GetIPAddress())
        Else
            acc.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_UPD, "LocationGroup", "แก้ไขชื่อกลุ่มร้านยา :" & txtName.Text, "", Environment.MachineName, GetIPAddress())
        End If
