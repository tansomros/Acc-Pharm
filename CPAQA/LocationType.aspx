<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="LocationType.aspx.vb" Inherits="CPAQA.LocationType" %>
      ...
      <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>ประเภทร้านยา
                            <div class="page-title-subheading">จัดการ เพิ่ม/แก้ไข ประเภทร้านยา </div>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="modal-content">
          <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h6 class="modal-title">จัดการประเภทร้านยา</h6>
          </div>
