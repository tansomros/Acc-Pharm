...
Public Class GPP
        ...
        If dt.Rows.Count > 0 Then
            For i = 0 To dt.Rows.Count - 1
                Select Case DBNull2Zero(dt.Rows(i)("ItemUID"))
                    ...
                    Case 40
                        optS5Q13.SelectedValue = dt.Rows(i)("Score")
                End Select
    ...
    Private Sub CalculateScore()
        ...
        'If StrNull2Zero(optS5Q13.SelectedValue) = -1 Then
        ...
        'If optS5Q13.SelectedValue = "1" Then
        '    lblScoreS5Q13.Text = "ผ่าน"
        '    lblScoreS5Q13.ForeColor = System.Drawing.Color.Green
        '    lblResult.Text = "ผ่าน"
        '    lblResult.ForeColor = System.Drawing.Color.Green

        'Else
        '    lblScoreS5Q13.Text = "ไม่ผ่าน"
        '    lblScoreS5Q13.ForeColor = System.Drawing.Color.Red
        '    lblResult.Text = "ไม่ผ่าน"
        '    lblResult.ForeColor = System.Drawing.Color.Red
        'End If
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        If Convert.ToInt32(Request.Cookies("ROLE_ID").Value) = 1 Then
            ctlA.GPP_Assessment_Save(StrNull2Zero(hdGPPUID.Value), StrNull2Zero(hdRequestUID.Value), StrNull2Zero(lblYear.Text), StrNull2Zero(hdLocationUID.Value), StrNull2Double(lblTotalScore.Text), NetScore, NetPercentage, AsmStatus, "", StrNull2Zero(Request.Cookies("userid").Value))
        Else
            ctlA.GPP_Assessment_Save(StrNull2Zero(hdGPPUID.Value), StrNull2Zero(hdRequestUID.Value), StrNull2Zero(lblYear.Text), StrNull2Zero(hdLocationUID.Value), StrNull2Double(lblTotalScore.Text), StrNull2Double(txtFinalScore.Text), StrNull2Double(lblFinalPercent.Text), ddlFinalResult.SelectedValue, txtRemark.Text, StrNull2Zero(Request.Cookies("userid").Value))
        End If
        ...
        Dim S2Q1, S3Q2, S3Q4, S3Q5, S5Q7, S5Q10, S5Q11 As Double
        ...
        ctlA.GPP_AssessmentScore_Save(StrNull2Zero(hdGPPUID.Value), 34, S5Q7, 2, StrNull2Double(lblScoreS5Q7.Text), StrNull2Zero(Request.Cookies("userid").Value))
        ...
        ctlA.GPP_AssessmentScore_Save(StrNull2Zero(hdGPPUID.Value), 37, S5Q10, 1, StrNull2Double(lblScoreS5Q10.Text), StrNull2Zero(Request.Cookies("userid").Value))
        ctlA.GPP_AssessmentScore_Save(StrNull2Zero(hdGPPUID.Value), 38, S5Q11, 1, StrNull2Double(lblScoreS5Q11.Text), StrNull2Zero(Request.Cookies("userid").Value))
        ...
        ctlA.GPP_AssessmentScore_Save(StrNull2Zero(hdGPPUID.Value), 40, StrNull2GPPVal(optS5Q13.SelectedValue), 0, 0, StrNull2Zero(Request.Cookies("userid").Value))

        ctlU.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_ADD, "GPP", "ReqID=" & hdRequestUID.Value, "บันทึก GPP", Environment.MachineName, GetIPAddress())
    ...
    Protected Sub optS5Q12_SelectedIndexChanged(sender As Object, e As EventArgs) Handles optS5Q12.SelectedIndexChanged
        CalculateScore()
    End Sub
    Protected Sub optS5Q13_SelectedIndexChanged(sender As Object, e As EventArgs) Handles optS5Q13.SelectedIndexChanged
        CalculateScore()
    End Sub
    ...
    End Sub
    Protected Sub imgS5Q13_Click(sender As Object, e As EventArgs) Handles imgS5Q13.Click
        Dim fPath As String = "imageUploads/" & hdLocationUID.Value & "/GPP/"
        hdAccID.Value = "40"
        lblTopic.Text = "ข้อที่ 5.13 แสดง ประกาศ หรือ แจ้งนโยบาย ต าม พรบ คุ้มครองข้อมูลส่วนบุคคล (Privacy Notice)"
        LoadImg()
        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "MessageAlert", "openModalUpload(this,'40');", True)
    End Sub
    ...
    Protected Sub txtFinalScore_TextChanged(sender As Object, e As EventArgs) Handles txtFinalScore.TextChanged
        ...
        If StrNull2Zero(lblScoreS1Q1.Text) = -1 Then
            ddlFinalResult.ForeColor = System.Drawing.Color.Red
            ddlFinalResult.SelectedValue = "N"
            Exit Sub
        End If
