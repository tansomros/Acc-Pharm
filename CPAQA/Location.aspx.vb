...
Public Class Location
    ...
    Protected Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        'If ctlR.Request_GetType(StrNull2Long(Request("id"))) <> 1 Then
        '    If txtAccLicense.Text = "" Then
        '        ScriptManager.RegisterStartupScript(Me.Page, Me.GetType(), "MessageAlert", "openModalWarningInfo(this,'ผลการตรวจสอบ','กรุณาระบุเลขที่ใบรับรองร้านยาคุณภาพ');", True)
        '        Exit Sub
        '    End If
        'End If
    ...
    Protected Sub cmdSaveSoftware_Click(sender As Object, e As EventArgs) Handles cmdSaveSoftware.Click
        ...
        If Not Directory.Exists(UploadDirectory) Then
            Directory.CreateDirectory(UploadDirectory)
        End If
        ctlL.LocationSoftware_Save(StrNull2Long(hdSoftwareUID.Value), StrNull2Long(Request("id")), hdLocationUID.Value, txtSname.Text, txtSdesc.Text, Request.Cookies("UserID").Value)
