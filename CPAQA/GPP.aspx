<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="GPP.aspx.vb" Inherits="CPAQA.GPP" %>
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    (Critical Defect) <span class="text-blue">( แนบ :ภาพมุมกว้างให้เห็นทั้งร้าน  พร้อมภาพ Floor Plan )</span> 
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:RadioButtonList ID="optS1Q2" runat="server"
                                                            RepeatDirection="Horizontal" CssClass="table no-border" AutoPostBack="True">
                                                            <asp:ListItem Value="-1">ไม่มี</asp:ListItem>
                                                            <asp:ListItem Value="0">ปรับปรุง</asp:ListItem>
                                                            <asp:ListItem Value="1"> พอใช้</asp:ListItem>
                                                ...
                                                <tr>
                                                    <td class="text-center">
                                                        <asp:LinkButton ID="imgS1Q3" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                    </td>
                                                    <td>ข้อที่ 1.3 บริเวณสำหรับให้คำปรึกษาและแนะนำการใช้ยา
                                                    ต้องเป็นสัดส่วนแยกออกจากส่วนบริการอื่นอย่างชัดเจน
                                                    มีพื้นที่พอสำหรับการให้คำปรึกษาและการจัดเก็บประวัติ
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="imgS1Q4" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="imgS1Q5" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                    </td>
                                                    <td class="text-red">ข้อที่ 1.5 สถานที่ขายยาต้องมีความแข็งแรงก่อสร้างด้วยวัสดุที่คงทนถาวร
                                                    เป็นสัดส่วนชัดเจน (Critical Defect) <span class="text-blue">(ทั้งนี้ กรณีร้านยาคุณภาพ จะต้องมีผนังสูงไม่น้อยกว่า 2 เมตร  3 ด้าน)</span>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="imgS1Q6" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="imgS1Q7" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="imgS1Q8" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:LinkButton ID="imgS1Q9" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">
                                                        <asp:Label ID="lblSumScoreS1" runat="server" Text=""></asp:Label></th>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="box-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS2Q1" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS2Q2" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS2Q3" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS2Q4" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS2Q5" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS2Q6" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>


                                            </td>
                                            <td class="text-red">ข้อที่ 2.6 อุปกรณ์สำหรับดับเพลิง จำนวน 1
                                            เครื่องในสภาพที่สามารถพร้อมใช้งานได้อย่างมีประสิทธิภาพ
                                            อยู่ในบริเวณสถานที่เก็บยา (Critical Defect)
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">คะแนนที่ได้</th>
                                            <th class="text-center">
                                                <asp:Label ID="lblSumScoreS2" runat="server" Text=""></asp:Label></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="box-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS3Q1" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                            </td>
                                    ...
                                    ความสามารถในการให้การบริการทางเภสัชกรรมชุมชน
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS3Q2" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>


                                            </td>
                                            <td>ข้อที่ 3.2 พนักงานร้านยา ต้องมีความรู้เกี่ยวกับกฎหมายยา
                                    และงานที่ได้รับมอบหมายจนสามารถปฏิบัติงานได้ดี
                                    และผ่านการอบรมอย่างต่อเนื่องและเพียงพอ <span class="text-red">(กรณีไม่มีพนักงานร้านยา ไม่ต้องตอบ ให้เว้นว่าง ระบบจะไม่คิดฐานคะแนน)</span>
                                            </td>
                                            <td>
                                                <table class="table no-border">
                                                    <tr>
                                    ...
                                    แสดงตนให้แตกต่างจากพนักงานร้านยาและบุคลากรอื่นภายในร้านขายยา
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS3Q4" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>


                                            </td>
                                            <td>ข้อที่ 3.4 การแต่งกายพนักงานร้านยาและบุคลากรอื่นภายในร้านขายยา
                                    ต้องใส่สีเสื้อ
                                    ป้ายแสดงตนไม่สื่อไปในทางที่จะก่อให้เกิดความเข้าใจว่าเป็นเภสัชกร<span class="text-red">(กรณีไม่มีพนักงานร้านยา ไม่ต้องตอบ ให้เว้นว่าง ระบบจะไม่คิดฐานคะแนน)</span>
                                            </td>
                                            <td>
                                                <table class="table no-border">
                                                    <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS3Q5" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                    ...
                                    โดยคำนึงถึงความถูกต้องตามกฎหมายว่าด้วยยาและกฎหมายว่าด้วยวิชาชีพเภสัชกรรม<span class="text-red">(กรณีไม่มีพนักงานร้านยา ไม่ต้องตอบ ให้เว้นว่าง ระบบจะไม่คิดฐานคะแนน)</span>
                                            </td>
                                            <td>
                                                <table class="table no-border">
                                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">คะแนนที่ได้</th>
                                            <th class="text-center">
                                                <asp:Label ID="lblSumScoreS3" runat="server" Text=""></asp:Label></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="box-body">
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q1" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q2" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q3" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q4" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q5" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q6" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS4Q7" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">คะแนนที่ได้</th>
                                            <th class="text-center">
                                                <asp:Label ID="lblSumScoreS4" runat="server" Text=""></asp:Label></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <span class="text-red">(กรณีไม่มีการผลิตยาตามใบสั่ง ฯ ไม่ต้องตอบ ให้เว้นว่างไว้ ระบบจะไม่คิดฐานคะแนน)</span>
                                            </td>
                                            <td>
                                                <table class="table no-border">
                                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            และต้องผ่านการอนุญาตถูกต้องตามกฎหมาย <span class="text-red">(กรณีไม่มีการวางสื่อ ไม่ต้องตอบ ให้เว้นว่างไว้ ระบบจะไม่คิดฐานคะแนน)</span>
                                            </td>
                                            <td>
                                                <table class="table no-border">
                                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            ๆ รวมทั้งกฎหมายว่าด้วยวิชาชีพเภสัชกรรม <span class="text-red">(กรณีไม่มีกิจกรรมดังกล่าว ไม่ต้องตอบ ให้เว้นว่างไว้ ระบบจะไม่คิดฐานคะแนน)</span>
                                            </td>
                                            <td>
                                                <table class="table no-border">
                                                    <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="imgS5Q13" runat="server" CssClass="file-upload btn btn-primary"><i class="fa fa-camera"></i></asp:LinkButton>
                                            </td>
                                            <td>ข้อที่ 5.13 แสดง ประกาศ หรือ แจ้งนโยบาย ต าม พรบ คุ้มครองข้อมูลส่วนบุคคล (Privacy Notice) 
                                            </td>
                                            <td>
                                                <asp:RadioButtonList ID="optS5Q13" runat="server" RepeatDirection="Horizontal" CssClass="table no-border" AutoPostBack="True">
                                            ...
                                            <td class="text-center">
                                                <asp:Label ID="lblScoreS5Q13" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">คะแนนที่ได้</th>
                                            <th class="text-center">
                                                <asp:Label ID="lblSumScoreS5" runat="server" Text=""></asp:Label></th>
                                        </tr>
                                    </tbody>
                                </table>
                                <br />
                            ...
                            <div class="col-lg-12">
                                <table class="table table-no-bordered">
                                    ...
                                    <tr>
                                        <td>คิดเป็น (%)</td>
                                        <td>
                                            <asp:Label ID="lblPercentage" runat="server" CssClass="text-bold text-blue"></asp:Label></td>
                                        <td>%</td>
                                    </tr>
                                    <tr>
                                        <td>สรุปผล</td>
                                        <td>
                                            <asp:Label ID="lblResult" runat="server" CssClass="text-bold"></asp:Label>
                                        </td>
                                        <td></td>
                                    </tr>
                                </table>
                            ...
                            <div class="col-lg-12 app-page-header">
                                <table class="table table-no-bordered">
                                    ...
                                    <tr>
                                        <td>คิดเป็น (%)</td>
                                        <td>
                                            <asp:Label ID="lblFinalPercent" runat="server" CssClass="text-bold text-blue"></asp:Label></td>
                                        <td>%</td>
                                    </tr>
                                    <tr>
                                        <td>สรุปผล</td>
