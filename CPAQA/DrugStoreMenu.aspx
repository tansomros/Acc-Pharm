<%@ Page Title="" Language="vb" AutoEventWireup="true" CodeBehind="DrugStoreMenu.aspx.vb" Inherits="CPAQA.DrugStoreMenu" %>
        ...
        <div class="container-login">
            ...
            <div class="row">
                <section class="col-lg-3 connectedSortable">
                    <div class="menu-box">
                        <div class="box-body">
                            <a href="DrugStoreMenu.aspx" class="btn btn-menu-main btn-menu btn-block-menu active">
                    ...
                    <div class="justify-content-center">
                        <div class="col-lg-12 my-3">
                            <div class="row justify-content-center">
                                <div class="col-sm-6">
                                    <a href="DrugStore.aspx" class="btn-icon-vertical mb-3 btn-transition btn-block btn btn-danger">                             
                                        <img src="images/pa_icon.png" />&nbsp;
                                        <span class="badge badge-primary badge-dot badge-dot-sm badge-dot-inside"></span>ร้านยาทั้งหมดในระบบ
                                    </a>
                                </div>
                                 </div>
                                  <div class="row justify-content-center">
                                <div class="col-sm-6">
                                    <a href="https://www.acc-pharm.com/Pharmacy" target="_blank" class="btn-icon-vertical mb-3 btn-transition btn-block btn btn-success">
                                         <img src="images/acc_icon.png" /> &nbsp;
                                        <span class="badge badge-danger badge-dot badge-dot-inside"></span>ร้านยาคุณภาพ
                                    </a>
                                </div>
                            </div>
