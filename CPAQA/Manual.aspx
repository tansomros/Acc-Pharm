<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="Manual.aspx.vb" Inherits="CPAQA.Manual" %>
...
<body>
    <form id="form1" class="user" runat="server">
     ...
     <span class="box-icon-menu"><i class="material-icons icon-menu verified_user">&#xe8e8;</i></span>ระเบียบ/ ประกาศ / ข้อบังคับ<br />Regulations
                            ...
                            <a href="Manual.aspx?p=m" class="btn btn-menu-main btn-menu btn-block-menu active">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center" width="30px">
                                                        <a href="<% =String.Concat(row("NewsLink")) %>"><i class="fa fa-list"></i></a>
                                                    </td>
                                                    <td><a href="<% =String.Concat(row("NewsLink")) %>" target="_blank"><% =String.Concat(row("NewsHead")) %></a></td>
                                                    <td class="text-center"><a href="<% =String.Concat(row("NewsLink")) %>" target="_blank"><small><% =String.Concat(row("Mwhen")) %></small></a></td>
                                                </tr>
                                                <%  Next %>
                                            </tbody>
                                        </table>                                   
