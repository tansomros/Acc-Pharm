<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Location.aspx.vb" Inherits="CPAQA.Location" %>
...
<section class="content">
                                    ...
                                    <div class="col-md-9">
                                      ...
                                      <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLicenseNo1" runat="server" cssclass="form-control text-center text-blue" BackColor="White" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
 ...
 <div class="col-md-3">
                                ...
                                <div class="row">
                                     <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>ละติจูด,ลองติจูด</label><button class="btn-icon btn-icon-only btn-link no-border ico-info small" type="button" data-title="Note" data-toggle="popover-custom-bg" data-bg-class="text-white small bg-primary" data-content="ละติจูด/ลองติจูด ในรูปแบบองศาทศนิยมเท่านั้น และคั่นชุดข้อมูลด้วยคอมม่า (,)" data-original-title="" title=""><i class="fa fa-info-circle btn-icon-wrapper" data-toggle="tooltip" data-placement="top" data-original-title="ละติจูด/ลองติจูด ในรูปแบบองศาทศนิยมเท่านั้น และคั่นชุดข้อมูลด้วยคอมม่า (,)"></i></button>
...
<div class="row">
          ...
          <div class="layer"></div>
                ...
                <asp:UpdatePanel ID="UpdatePanelSoftwareList" runat="server">
                                <ContentTemplate>                                                     
<asp:GridView ID="grdSoftware" CssClass="table table-hover" runat="server" CellPadding="2"                            GridLines="None"                   AutoGenerateColumns="False"                   Font-Bold="False">
                        <RowStyle BackColor="#F7F7F7" />
                        <columns>
                            <asp:BoundField DataField="nRow" HeaderText="No." >
                            <ItemStyle HorizontalAlign="Center" Width="30px" />
 ...
 <div id="modal-window" class="modal fade modal-window"  role="dialog" data-backdrop="static" tabindex="-1" style="display: none;z-index: 9999;" aria-hidden="true">
  ...
  <button class="btn btn-secondary" data-dismiss="modal">Close</button>
	...
	<!--- End Modal --->
            ...
            <div class="box-header">
              <i class="fa fa-grear"></i>
              <h3 class="box-title">บริการต่างๆและช่องทางการติดต่อสื่อสาร / ประชาสัมพันธ์ กับผู้รับบริการในปัจจุบัน</h3>        
                 <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
              </div>                                 
            ...
            <div class="box-body"> 
                ...
                <tr>
                  ...
                  <th class="text-left" width="300px">บริการ /  ช่องทางการติดต่อ</th>
                ...
                <tbody>
                    <tr>
                                <td>1.</td>
                                <td>บรืการคัดกรองความเสี่ยง เบาหวาน ความดัน</td>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td>4.</td>
                                <td>Telepharmacy ของบริษัทที่มี Platform  </td>
                             ...
                             <tr>
                                <td>8.</td>
                                <td>มี Line OA หรือ มี Line ธรรมดาของร้าน </td>
