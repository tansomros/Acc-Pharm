<%@ Page Title="จัดการข่าวประชาสัมพันธ์" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="NewsAdd.aspx.vb" Inherits="CPAQA.NewsAdd" %>
       ...
       <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>News & Article
                                    <div class="page-title-subheading">จัดการข่าวประชาสัมพันธ์ และบทความ บนหน้าเพจเว็บไซต์</div>
                                </div>
                            </div>
                        </div>
                    </div>      
        ...
        <asp:Panel ID="pnContent" runat="server" Width="100%">
                ...
                <dx:ASPxHtmlEditor ID="txtDetail" runat="server"   Width="100%" Theme="Default" Height="600px">  
                                            <SettingsDialogs>
                                                <InsertImageDialog>
                                                    <SettingsImageUpload>
                                                        <FileSystemSettings UploadFolder="~/imagenews" />
                                                    </SettingsImageUpload>                                                   
                                                </InsertImageDialog>
                    </SettingsDialogs>
                                            </dx:ASPxHtmlEditor>
...
&nbsp;<asp:Button ID="cmdDelFile" runat="server" CssClass="btn btn-danger" Text="ลบเอกสารแนบ" />
        ...
        <div class="button r" id="button-3"> 
              <input id="chkNews1" type="checkbox" class="checkbox" runat="server">          
          <div class="knobs"></div>
          <div class="layer"></div>
        </div>
                            </div>
        ...
        <div class="button r" id="button-4"> 
              <input id="chkNews2" type="checkbox" class="checkbox" runat="server" checked="checked">          
          <div class="knobs"></div>
          <div class="layer"></div>
        </div>
                            </div>
