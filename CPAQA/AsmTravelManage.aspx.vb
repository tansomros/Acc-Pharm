...
Public Class AsmTravelManage
    ...
    Private Sub LoadData()
        ...
        dt = ctlU.AssessorTravel_Get(Request.Cookies("UserID").Value)
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        For i = 0 To iD - 1
            ...
            Edate = Bdate
            ctlU.AssessorTravel_Add(Request.Cookies("UserID").Value, Bdate, Edate, ddlProvince.SelectedValue, txtRemark.Text)
        Next
        grdData.PageIndex = 0
        LoadData()
    End Sub
    ...
    Private Sub grdData_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles grdData.RowCommand
        If TypeOf e.CommandSource Is WebControls.LinkButton Then
            ...
            Select Case ButtonPressed.ID
                Case "imgDel"
                    If ctlU.AssessorTravel_Delete(e.CommandArgument) Then
