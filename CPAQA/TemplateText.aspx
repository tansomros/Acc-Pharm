<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TemplateText.aspx.vb" Inherits="CPAQA.TemplateText" %>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div class="page-title-icon">
                            <i class="pe-7s-chat icon-gradient bg-primary"></i>
                        </div>
                        <div>Template ข้อความตอบกลับ
                            <div class="page-title-subheading">จัดการ เพิ่ม/แก้ไข Template ข้อความตอบกลับ </div>
                        </div>
                    </div>
                </div>
            </div> 
...
<section class="content">  
      ...
      <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon pe-7s-chat icon-gradient bg-success">
            </i>Template ข้อความตอบกลับ
...
<asp:GridView ID="grdData" CssClass="table table-hover"  
                      ...
                      AutoGenerateColumns="False"  
                        ...
                        <columns>
                            ...
                            <asp:BoundField DataField="Descriptions" HeaderText="ข้อความ" />                                                
                             <asp:TemplateField>
              <itemtemplate>
        ...
        <div class="modal-content">
          <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h6 class="modal-title">จัดการTemplate ข้อความตอบกลับ</h6>
          </div>
 ...
 <div class="row">
          ...
          <div class="form-group">
            <label>Descriptions</label>
              <asp:TextBox ID="txtDescriptions" runat="server" cssclass="form-control" placeholder=""></asp:TextBox>
          </div>
