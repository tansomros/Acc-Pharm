<%@ Page Title="User Account" MetaDescription="จัดการข้อมูลผู้ใช้งาน" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UserModify.aspx.vb" Inherits="CPAQA.UserModify" %>
         ...
         <div class="col-md-12">
          <div class="form-group">
            ...
            <asp:DropDownList ID="ddlType" runat="server" cssclass="form-control select2" Width="100%" AutoPostBack="True">    
                ...
                <asp:ListItem Selected="True" Value="2">สำนักงานรับรองร้านยาคุณภาพ</asp:ListItem>
                 <asp:ListItem  Value="3">สภาเภสัชกรรม</asp:ListItem>         
                <asp:ListItem  Value="4">สำนักงานสาธารณสุขจังหวัด (สสจ.)</asp:ListItem>   
            </asp:DropDownList>
          </div>
        </div>
      </div> 
         ...
         <div class="col-md-12">
          <div class="form-group">
            ...
            <asp:DropDownList ID="ddlLocation" runat="server" cssclass="form-control select2">
              ...
              <div class="row" id="pnPPH" runat="server">          
         <div class="col-md-12">
          <div class="form-group">
            <label>จังหวัด</label>
   ...
   <div class="card-header"><i class="header-icon lnr-lock icon-gradient bg-primary">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label>ระดับสิทธิ์</label>
               <asp:RadioButtonList ID="chkGroup" runat="server" RepeatColumns="2">
            </asp:RadioButtonList> 
          </div>
        ...
        <div id="pnAdmin" class="col-md-6" runat="server">
          ...
          <div class="layer"></div>
                      ...
                      <td>Admin ร้านยาสภาเภสัชกรรม</td> 
                  </tr>
                   <tr>
                      <td>   <div class="button r" id="button-5"> 
              <input id="chkAdminComp" type="checkbox" class="checkbox" runat="server" >          
          <div class="knobs"></div>
          <div class="layer"></div>
        </div></td>
                      <td>ระบบจัดการคำร้องเรียน</td> 
                  </tr>
                  <tr>
                      <td colspan="2">สำหรับ Admin สสจ.เท่านั้น</td>
                  </tr>
                   <tr>
                      <td>   <div class="button r" id="button-4"> 
              <input id="chkReporter" type="checkbox" class="checkbox" runat="server" >          
          <div class="knobs"></div>
          <div class="layer"></div>
        </div></td>
                      <td>สามารถดูรายงานรายจังหวัด (กำหนดสิทธิ์ที่เมนู "Assign จังหวัด")</td> 
                  </tr>
              </table>
