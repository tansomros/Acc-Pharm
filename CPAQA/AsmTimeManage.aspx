<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AsmTimeManage.aspx.vb" Inherits="CPAQA.AsmTimeManage" %>
      ...
      <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    บันทึกวันเวลาพร้อมออกตรวจ
					<div class="page-title-subheading">จัดการวันเวลาที่ท่านพร้อมออกตรวจประเมิน</div>
                </div>
            </div>
        </div>
    </div> 
...
<section class="content">  
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 col-xl-3">
                        <div class="form-group">
                            <label>ระบุช่วงเวลา</label><br />
                            <asp:DropDownList ID="ddlTime" runat="server" CssClass="form-control select2">
                                 <asp:ListItem Selected="True" Value="AM">เช้า (9.00-12.00 น.)</asp:ListItem>
                                <asp:ListItem Value="PM">บ่าย  (13.00-16.00 น.)</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                     <div class="col-lg-6 col-md-4 col-xl-3">
    ...
    <div class="box box-success">
            <div class="box-header">
              ...
              <h3 class="box-title">รายการวันเวลาของท่าน</h3>
            ...
            <div class="box-body mailbox-messages"> 
             ...
             AllowPaging="True" CssClass="table table-hover"                              Font-Bold="False" Width="100%" AutoGenerateColumns="False" DataKeyNames="UID">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PeriodName" HeaderText="ช่วงเวลา" />  
