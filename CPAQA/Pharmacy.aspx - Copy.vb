...
Public Class Pharmacy
    ...
    Private Sub LoadData()
        dtLoc = ctlL.Location_GetForWeb(ddlProvinceGroup.SelectedValue, ddlProvince.SelectedValue, ddlAccPharm.SelectedValue, ddlAccStatus.SelectedValue, txtSearch.Text)
    End Sub
