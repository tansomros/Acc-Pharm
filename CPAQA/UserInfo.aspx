<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"  CodeBehind="UserInfo.aspx.vb" Inherits="CPAQA.UserInfo" %>
                    ...
                    <i class="fa fa-minus"></i></button>
                            ...
                            <div class="box-body" align="center">
                                ...
                                <div id="externalDropZone" class="dropZoneExternal">
                                    ...
                                    <img id="uploadedImage" src='<% Response.Write(CPAQA.PictureUser & "/" & Session("userimg")) %>' width="150" height="150" class="profile-user-img img-responsive img-circle" alt="" onload="onImageLoad()" />
