<%@ Page Title="News - ข่าวประชาสัมพันธ์" Language="VB" AutoEventWireup="true" CodeBehind="News.aspx.vb" Inherits="CPAQA.News" %>
                ...
                <section class="col-lg-3 connectedSortable">
                    <div class="menu-box">
                        <div class="box-body">
                            ...
                            <a href="News.aspx" class="btn btn-menu-main btn-menu btn-block-menu active">
                ...
                <section class="col-lg-9 connectedSortable">
                    <div class="justify-content-center">
                        <div class="col-lg-12 my-4">
                            <div class="main-card card-solid">
                      ...
                      <tr>
                          ...
                          <td class="no-border justify-content-end">
                                                ...
                                                <div class="card card-sm card-post h-100">
                                                    <div class="card-media">
                                                        <a target="_blank" href='<% Response.Write(dtNew.Rows(i)("NewsLink")) %>' title='<% Response.Write(dtNew.Rows(i)("NewsHead")) %>' rel="bookmark">
                                                            <img src="<% Response.Write(CPAQA.ImageCoverNews + dtNew.Rows(i)("CoverimagePath")) %>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" height="160" width="300" alt="" />
                                                        </a>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <center>
                                            <table id="tblPaging" runat="server">
                                                <tr>
                                                    <td style="padding: 7px" valign="middle">
                                                    ...
                                                    <td valign="top">
                                                        <asp:DataList ID="dlPaging" runat="server" OnItemCommand="dlPaging_ItemCommand"
                                                            OnItemDataBound="dlPaging_ItemDataBound" RepeatDirection="Horizontal" CssClass="dc_pagination dc_paginationC dc_paginationC01">
                                                            <ItemTemplate>
                            ...
                            <div class="main-card mb-3 card-solid">
                                <div class="card-body">
                                    <video id="studyVid" autoplay="autoplay" controls="controls" muted width="100%">
                                        <source src="https://www.acc-pharm.com/Documents/VDO1.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
                        </div>
