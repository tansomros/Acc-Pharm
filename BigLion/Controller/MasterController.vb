...
#Region "Acc / Asm  Status"
    ...
    Public Function AssessmentStatus_GetForReport() As DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function RequestStatus_GetForReport() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "RequestStatus_GetForReport")
        Return ds.Tables(0)
    End Function
    Public Function GetAccPharmYear() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "GetAccPharmYear")
        Return ds.Tables(0)
    End Function
    Public Function GetRiskYear() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "GetRiskYear")
        Return ds.Tables(0)
    End Function


    Public Function GetGPPYear() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "GetGPPYear")
        Return ds.Tables(0)
    End Function

    Public Function GetAsmYear() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "GetAsmYear")
        Return ds.Tables(0)
    End Function
#End Region
...
#Region "Province"
    ...
    Public Function Province_GetID(Code As String) As String
        ...
        End If
    End Function
    Public Function Province_GetIDByName(Name As String) As String
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("Province_GetIDByName"), Name)
        If ds.Tables(0).Rows.Count > 0 Then
            Return String.Concat(ds.Tables(0).Rows(0)(0))
        Else
            Return "00"
...
#Region "District"
    Public Function District_Get(ProvinceID As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("District_Get"), ProvinceID)
        Return ds.Tables(0)
    End Function
    Public Function District_GetForReport(ProvinceID As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("District_GetForReport"), ProvinceID)
        Return ds.Tables(0)
    End Function
...
#Region "WarningType"
    Public Function WarningType_Get() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "WarningType_Get")
        Return ds.Tables(0)
    End Function

    Public Function WarningType_Get4Report() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "WarningType_Get4Report")
        Return ds.Tables(0)
    End Function
    Public Function WarningType_GetBySearch(KeySearch As String) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("WarningType_GetBySearch"), KeySearch)
        Return ds.Tables(0)
    End Function
    Public Function WarningType_GetByUID(UID As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, GetFullyQualifiedName("WarningType_GetByUID"), UID)
        Return ds.Tables(0)
    End Function
    Public Function WarningType_Delete(pID As Integer) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, "WarningType_Delete", pID)
    End Function
    Public Function WarningType_Save(UID As Integer, Name As String, Sort As Integer, StatusFlag As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, "WarningType_Save", UID, Name, Sort, StatusFlag)
    End Function
#End Region
