...
#Region "QA"
    ...
    Public Function QA_AssessmentScore_Save2(ByVal QA_Assessment_UID As Long, ByVal RequestUID As Long, ByVal Score1 As Double, ByVal AuditorComment1 As String, ByVal Score2 As Double, ByVal AuditorComment2 As String, ByVal Score3 As Double, ByVal AuditorComment3 As String, ByVal AsmStatus As String, ByVal Muser As Integer) As Integer

        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("QA_AssessmentScore_Save2"), QA_Assessment_UID, RequestUID, Score1, AuditorComment1, Score2, AuditorComment2, Score3, AuditorComment3, AsmStatus, Muser)
    End Function
