...
#Region "GPP"
    ...
    End Function
    Public Function GPP_Assessment_PPH_Save(ByVal UID As Integer, ByVal RequestUID As Integer, ByVal AsmYear As Integer, ByVal LocationUID As Integer, ByVal TotalScore As Double, ByVal FinalScore As Double, ByVal PercentScore As Double, ByVal FinalResult As String, ByVal Remark1 As String, ByVal Remark2 As String, ByVal Remark3 As String, ByVal Remark4 As String, ByVal Remark5 As String, ByVal Remark As String, MUser As Integer, PercentGroup1 As Double, PercentGroup2 As Double, PercentGroup3 As Double, PercentGroup4 As Double, PercentGroup5 As Double, RiskRemark As String, AsmDate As String, AsmTime As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("GPP_Assessment_PPH_Save"), UID, RequestUID, AsmYear, LocationUID, TotalScore, FinalScore, PercentScore, FinalResult, Remark1, Remark2, Remark3, Remark4, Remark5, Remark, MUser, PercentGroup1, PercentGroup2, PercentGroup3, PercentGroup4, PercentGroup5, RiskRemark, AsmDate, AsmTime)
    End Function
...
#Region "QA"
    ...
    Public Function QA_AssessmentScore_Save2(ByVal QA_Assessment_UID As Long, ByVal RequestUID As Long, ByVal Score1 As Double, ByVal AuditorComment1 As String, ByVal Score2 As Double, ByVal AuditorComment2 As String, ByVal Score3 As Double, ByVal AuditorComment3 As String, ByVal AsmStatus As String, ByVal ScoreRisk1 As Integer, ByVal ScoreRisk2 As Integer, ByVal ScoreRisk3 As Integer, ByVal ScoreRisk4 As Integer, ByVal ScoreRisk5 As Integer, ByVal ScoreRisk6 As Integer, ByVal ScoreRisk7 As Integer, ByVal ScoreRisk8 As Integer, ByVal ScoreRisk9 As Integer, ByVal ScoreRisk10 As Integer, ByVal ScoreQ1 As Integer, ByVal ScoreQ2 As Integer, ByVal ScoreQ3 As Integer, ByVal ScoreQ4 As Integer, ByVal ScoreQ5 As Integer, ByVal ScoreQ6 As Integer, ByVal ScoreQ7 As Integer, ByVal Muser As Integer) As Integer
