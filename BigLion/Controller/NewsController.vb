...
Public Class NewsController
    ...
    Public Function News_GetActive() As DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function News_GetPageCountBySearch(Category As String, SiteFlag As String, Search As String) As Integer
        ds = SqlHelper.ExecuteDataset(ConnectionString, "News_GetPageCountBySearch", Category, SiteFlag, Search)
    ...
    Public Function News_GetSearch(Category As String, SiteFlag As String, Search As String, CurrentPage As Integer) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "News_GetSearch", Category, SiteFlag, Search, CurrentPage)
        Return ds.Tables(0)
    End Function
    ...
    End Function
    Public Function News_UpdateFileName(ByVal NewsID As Integer, ByVal FilePath As String) As Integer
        Return SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("News_UpdateFileName"), NewsID, FilePath)
    End Function
...
#Region "Manual"
    Public Function Manual_Get() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "Manual_Get")
        Return ds.Tables(0)
    End Function
    Public Function Manual_GetActive() As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "Manual_GetActive")
        Return ds.Tables(0)
    End Function
    Public Function Manual_GetSearch(SiteFlag As String, Search As String) As DataTable
        ds = SqlHelper.ExecuteDataset(ConnectionString, "Manual_GetSearch", SiteFlag, Search)
        Return ds.Tables(0)
    End Function
#End Region
